...
public class FileToolsTest2 {
	
	private static final Logger LOG = LoggerFactory.getLogger(FileToolsTest2.class);
...
/*			String path = "G:\\Album\\Beauty\\Koharu Nishino";
			...
			File dir = new File("G:\\Album\\Beauty\\Yuuka Himekawa");
